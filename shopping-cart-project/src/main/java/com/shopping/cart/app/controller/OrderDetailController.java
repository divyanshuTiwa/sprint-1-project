...
import com.shopping.cart.app.exception.OrderDetailNotFoundException;
...
public class OrderDetailController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<HttpStatus> deleteOrderDetail(@PathVariable long id) throws OrderDetailNotFoundException {
