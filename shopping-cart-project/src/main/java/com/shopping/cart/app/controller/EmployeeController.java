...
import com.shopping.cart.app.exception.EmployeeNotFoundException;
...
public class EmployeeController {
    ...
    private EmployeeRepository employeeRepository;
 	...
 	//GET
    /*@GetMapping
    public List<Employee>  EmployeeController(){
...
*/
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<HttpStatus> deleteEmployee(@PathVariable long id) throws EmployeeNotFoundException {
