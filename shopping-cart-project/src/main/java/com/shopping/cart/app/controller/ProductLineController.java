...
import com.shopping.cart.app.exception.ProductLineNotFoundException;
...
public class ProductLineController {
	...
	*/
	...
	@PutMapping("/{id}")
    public ResponseEntity<ProductLine> updateProductLine(@PathVariable long id,@RequestBody ProductLine productLine) throws ProductLineNotFoundException {
	...
	@DeleteMapping("/{id}")
    public ResponseEntity<HttpStatus> deleteProductLine(@PathVariable long id) throws ProductLineNotFoundException{
