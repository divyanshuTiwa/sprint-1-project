...
import com.shopping.cart.app.exception.OrderNotFoundException;
...
public class OrderController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<HttpStatus> deleteOrder(@PathVariable long id) throws OrderNotFoundException {
