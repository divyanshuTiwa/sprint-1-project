...
import com.shopping.cart.app.exception.OfficeNotFoundException;
...
public class OfficeController {
	...
	@PutMapping("/{id}")
    public ResponseEntity<Office> updateOffice(@PathVariable long id,@RequestBody Office office) throws OfficeNotFoundException {
	...
	@DeleteMapping("/{id}")
    public ResponseEntity<HttpStatus> deleteOffice(@PathVariable long id) throws OfficeNotFoundException{
